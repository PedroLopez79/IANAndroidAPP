...
public class parametrosinventarios extends AppCompatActivity {
    ...
    Button btnfechainicial, btnfechafinal, btnAceptar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parametrosinventarios.AsyncCallWS task = new parametrosinventarios.AsyncCallWS();
        task.execute();
        ...
        btnAceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                parametrosinventarios.AsyncCallWSGeneraReporte generaReporte = new parametrosinventarios.AsyncCallWSGeneraReporte();
    ...
    public String generaReportePDF(String fechaini, String fechafin, String numeroestacion, String idalmacen)
    {
        ...
        try {
            SoapObject Request = new SoapObject(NAMESPACE, METHOD_NAME);
            Request.addProperty("nombrereporte", "INVENTARIO FISICO MERMAS");
    ...
    private class AsyncCallWS extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            adapter = new ArrayAdapter<String>(parametrosinventarios.this, R.layout.spinner_item, listado);
    ...
    private class AsyncCallWSGeneraReporte extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            intent.putExtra("numeroestacion", numestacion);
            intent.putExtra("idalmacen", gidalmacen);
            intent.putExtra("NOMBREREPORTE", "INVENTARIO FISICO MERMAS");
